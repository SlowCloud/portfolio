...
- SSAFY Best Member 선정 <sub>2024.11
...
대학교 캡스톤 프로젝트로 진행하였던 팀 프로젝트입니다. 각 클라우드 서비스의 스펙과 비용을 그래프의 형태로 비교할 수 있게 해 주는 프로젝트입니다.
...
- 스크림 주도
  - 주마다 모임을 가져 개발 상황을 확인하고 앞으로의 개발 방향을 결정하는 등 팀을 이끎
...
여행 경로를 계획하고, 공유하고, 리뷰할 수 있는 프로젝트입니다.
초기에 프론트엔드를 JSP로 구성하였으며, 이후 VueJS 기반 프론트엔드와 REST API로 분리하는 작업을 진행하였습니다.

스프링부트의 기능을 활용해보고 익히는 기회가 되었습니다.
...
문제점을 파악하고 빠르게 해결하는 경험을 쌓았고, 데브옵스, 백엔드 라이브러리 등 새로운 기술을 익히고 활용해보는 기회가 되었습니다.

- 임베디드 개발 참여
  - 초기 임베디드 모듈 아키텍처 설계 참여
  - 4시간동안 해결되지 않은 모듈 통합 단계에서 발생한 문제 디버깅에 참여하여 10분 내로 해결
- 백엔드 구성
...
MQTT, 웹소켓 등을 통해 실시간 통신을 구성하고 활용해보는 기회가 되었습니다.
코드를 되돌아보면서, 코드부터 작성하는 것보단 어느 정도 설계를 해 두고 개발하는 것이 훨씬 낫다는 것을 깨닫게 된 경험이었습니다.
...
Golang과 같은 새로운 기술을 익히고 활용해본 경험이었으며, 오픈소스까지 기여해보는 등 많은 경험을 해보게 되었습니다.
